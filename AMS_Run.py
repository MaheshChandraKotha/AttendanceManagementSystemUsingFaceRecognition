    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name='D:\fcr2\Attendance_manage\Attendance\Manually Attendance'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"D:\fcr2\Attendance_manage\Attendance\-------Check atttendance-------"')

            attf = tk.Button(MFW,  text="Check Sheets",command=attf,fg="white"  ,bg="white"  ,width=12  ,height=1 ,activebackground = "Red" ,font=('times', 14, ' bold '))
    ...
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='snow')
                cs = 'D:\fcr2\Attendance_manage/' + fileName
    ...
    def log_in():
        ...
        if username == 'admin' :
            if password == 'admin':
                ...
                cs = 'D:\fcr2\Attendance_manage\StudentDetails'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
clearButton = tk.Button(window, text="Clear",command=clear,fg="black"  ,bg="grey"  ,width=10  ,height=1 ,activebackground = "Red" ,font=('times', 15, ' bold '))
clearButton.place(x=950, y=210)

clearButton1 = tk.Button(window, text="Clear",command=clear1,fg="black"  ,bg="grey"  ,width=10 ,height=1, activebackground = "Red" ,font=('times', 15, ' bold '))
